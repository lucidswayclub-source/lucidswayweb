...
function syncTheme(){const dark=document.documentElement.dataset.theme==='dark';themeButton.setAttribute('aria-pressed',String(dark));themeButton.setAttribute('aria-label',dark?'Increase red glow':'Dim red glow');themeButton.querySelector('.theme-icon').textContent=dark?'☀':'☾';themeButton.querySelector('.theme-label').textContent=dark?'Glow':'Dim';document.querySelector('meta[name="theme-color"]').content=dark?'#000000':'#c71920'}
